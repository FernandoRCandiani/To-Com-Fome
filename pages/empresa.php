        ...
        <div class="col-2 bg-tela-terciario">
          <div class="row d-flex justify-content-center">
            ...
            <div class="col-10 text-start corCinza bg-Mural rounded-3 p-3 mb-3">
              <p class="mb-2 fonte-0 border-azul ps-2 h-75">Obrigados a todos que estão ajudando, juntos estamos salvando muitas vidas.</p>
              <p class="m-0 fonte-1 ps-3">Joacir - Itaquera</p>
            </div>

            <div class="col-10 text-start corCinza bg-Mural rounded-3 p-3 mb-3">
              <p class="mb-2 fonte-0 border-verde ps-2 h-75">Distribuição de Comidas hoje no Parque do Carmo</p>
              <p class="m-0 fonte-1 ps-3">Joacir - Itaquera</p>
            </div>

            <div class="col-10 text-start corCinza bg-Mural rounded-3 p-3 m-0">
              <p class="mb-2 fonte-0 border-vermelho ps-2 h-75">Região leste está com muita demanda, devido ao alto numero de desabrigados.</p>
              <p class="m-0 fonte-1 ps-3">Joacir - Itaquera</p>
            </div>
